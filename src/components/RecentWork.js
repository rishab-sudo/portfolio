...
const RecentWork = () => {
  ...
  const cardData = [
    ...
    },
    {
      ...
      link: "https://marketingagency.com"
    },
    {
      id: 4,
      ...
      link: "https://www.designconnect.studio/"
    },
    {
      id: 5,
      ...
      link: "https://architecturefirm.com"
    },
    {
      id: 6,
    ...
    },
    {
      ...
      link: "https://main.d2h75xamxlpf5y.amplifyapp.com/"
    },
    {
      id: 10,
        ...
        <Container className="stack-section-card">
          {cardData.map((card, index) => (
            <div
              ...
              onClick={() => window.open(card.link, "_blank")} // 👈 Redirect to link
